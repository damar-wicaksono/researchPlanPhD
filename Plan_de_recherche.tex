...
In statistical uncertainty analysis, the input and physical model parameters are modeled as random variable ($\mathbf{\Theta}_i$ and $\mathbf{\Theta}_m$, respectively) with probability distributions. 
Then using Monte Carlo technique, samples are generated from their respective distribution.
These samples are used to run the code multiple times resulting in multiple results. 
...
\end{equation}
where
%<img class="tex" alt="&#10;C_{2\epsilon}^* = C_{2\epsilon} + {C_\mu \eta^3 (1-\eta/\eta_0)\over 1+\beta\eta^3}&#10;" src="/W/images/math/e/2/a/e2a27a85f6d4262011ab7fcab0da9941.png" />
and
%<img class="tex" alt="&#10;\eta = S k / \epsilon&#10;" src="/W/images/math/1/6/9/1693f90d80dfa8132311443a160b180f.png" />
and
%<img class="tex" alt="&#10;S=(2S_{ij}S_{ij})^{1/2}&#10;" src="/W/images/math/4/c/0/4c05eea8c0df2b78ab86e60fa80b48d1.png" />
